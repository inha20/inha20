...
|---|---|---|---|
| 1 | [KMap Structure Invariance](https://inha20.github.io/1KMapStructureInvariance/) | Karnaugh map visual patterns; XOR/XNOR checkerboard structures | Stable |
| 2 | [Symmetric Boolean Functions](https://inha20.github.io/2SymmetricBooleanFunctionMinorThesis/) | Symmetric Boolean functions; Hamming Weight layers; ring structures | Stable |
| 3 | [Variable Rearrangement Invariance](https://inha20.github.io/3VariableRearrangementInvarianceMinorThesis/) | Variable rearrangement; structural invariance under transformation | Active |
| 4 | [Structure Recognition Theory](https://inha20.github.io/4StructureRecognitionTheory/) | Meta-theory explaining why structures become research-worthy | Active |
...
|---|---|---|
| [5HumanAIResearchCollaboration](https://inha20.github.io/5HumanAIResearchCollaboration/) | Long-term Human-AI research collaboration; externalized memory; AI-to-AI handover | Active |
| [ANTIGRAVITY](https://inha20.github.io/ANTIGRAVITY/) | AI collaboration workspace; session continuity; handover documents | Monitoring |
